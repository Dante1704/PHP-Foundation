<!-- 
ahora este controlador es resposable de mostrar un form para crear una nota
-->
<?php
...
//antes de que se creara store.php iba todo esto
/* 
...
//antes de que se creara la function view que ayuda a redirigir
/* $heading = 'Create Note'; */
